      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            ...
            <p className="text-muted-foreground animate-fade-slide-up" style={{ animationDelay: "0.25s" }}>
              With over 2 years of experience in web development, I specialize
              in creating responsive, accessible, and performant web applications
              using modern technologies.
            </p>

            <p className="text-muted-foreground animate-fade-slide-up" style={{ animationDelay: "0.35s" }}>
